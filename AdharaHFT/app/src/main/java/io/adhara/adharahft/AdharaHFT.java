...
interface AdharaHFTPriceListener {
...
public class AdharaHFT {
    ...
    public class myResponseHandler implements ResponseHandler<String> {
        ...
        public AdharaHFTPriceListener listener;
    ...
    public long getPriceBegin(List<String> securities, List<String> tinterfaces, String granularity, int levels, int interval, AdharaHFTPriceListener listener ) throws IOException, InterruptedException, CertificateException, NoSuchAlgorithmException, KeyStoreException, KeyManagementException {
        hftRequest hftrequest = new hftRequest();
    ...
    public long getPositionBegin(List<String> assets, List<String> securities, List<String> accounts, int interval, AdharaHFTPriceListener listener ) throws IOException, InterruptedException, CertificateException, NoSuchAlgorithmException, KeyStoreException, KeyManagementException {
        hftRequest hftrequest = new hftRequest();
    ...
    public long getOrderBegin(List<String> securities, List<String> tinterfaces, List<String> types, int interval, AdharaHFTPriceListener listener ) throws IOException, InterruptedException, CertificateException, NoSuchAlgorithmException, KeyStoreException, KeyManagementException {
        hftRequest hftrequest = new hftRequest();
    ...
    private long sendRequest(hftRequest hftrequest, myResponseHandler responseHandler, String urlpath, boolean stream, AdharaHFTPriceListener listener) throws IOException, InterruptedException, CertificateException, NoSuchAlgorithmException, KeyStoreException, KeyManagementException {
        if (token==null){
            return -1;
        }
